# The file uses deepseek reason's API to assess the personality traits of a character based on a story
# It uses OpenAI's generated stories from personality_data.csv
# Results are stored in deepseek_reason.csv and deepseek_reason_na.csv (when "n/a" values are allowed)
...
df["deepseek_reason_grade"] = output
df.to_csv('deepseek_reason.csv', index=False)
...
df2["deepseek_reason_grade_na"] = output2
df2.to_csv('deepseek_reason_na.csv', index=False)